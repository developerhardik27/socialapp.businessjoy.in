                            ...
                            <div class="iq-card-body">
                                <table class="table table-bordered table-responsive-sm w-100 text-center p-0">
                                    ...
                                    <tbody id="admincheckboxes">
                                        ...
                                        @if (session('user_permissions.adminmodule.package.edit') == '1' || $user_id == 1)
                                            <tr id="package">
                                                <td>Package</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='package' id="showpackagemenu"
                                                        name="showpackagemenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.package.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpackagemenu' id="addpackage"
                                                            name="addpackage" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.package.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpackagemenu' id="viewpackage"
                                                            name="viewpackage" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.package.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpackagemenu' id="editpackage"
                                                            name="editpackage" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.package.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpackagemenu' id="deletepackage"
                                                            name="deletepackage" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.package.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showpackagemenu' id="alldatapackage"
                                                            name="alldatapackage" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                        ...
                                        @if (session('user_permissions.adminmodule.subscription.edit') == '1' || $user_id == 1)
                                            <tr id="subscription">
                                                <td>Subscription</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='subscription' id="showsubscriptionmenu"
                                                        name="showsubscriptionmenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.subscription.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showsubscriptionmenu' id="addsubscription"
                                                            name="addsubscription" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.subscription.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showsubscriptionmenu' id="viewsubscription"
                                                            name="viewsubscription" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.subscription.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showsubscriptionmenu' id="editsubscription"
                                                            name="editsubscription" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.subscription.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showsubscriptionmenu' id="deletesubscription"
                                                            name="deletesubscription" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.adminmodule.subscription.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showsubscriptionmenu' id="alldatasubscription"
                                                            name="alldatasubscription" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                    ...
                                    <tbody id="quotationcheckboxes">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.quotationformsetting.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            ...
                                                            id="addquotationformsetting" name="addquotationformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                        ...
                                        @if (session('user_permissions.quotationmodule.thirdpartyquotation.edit') == '1' || $user_id == 1)
                                            <tr id="thirdpartyquotation">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='thirdpartyquotation' id="showthirdpartyquotationmenu"
                                                        name="showthirdpartyquotationmenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu' id="addthirdpartyquotation"
                                                            name="addthirdpartyquotation" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu' id="viewthirdpartyquotation"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu' id="editthirdpartyquotation"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu' id="deletethirdpartyquotation"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu' id="alldatathirdpartyquotation"
                                    ...
                                    <tbody id="invoicecheckboxes">
                                        ...
                                        @if (session('user_permissions.invoicemodule.invoicecommission.edit') == '1' || $user_id == 1)
                                            <tr id="invoicecommission">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='invoicecommission' id="showinvoicecommissionmenu"
                                                        name="showinvoicecommissionmenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu' id="addinvoicecommission"
                                                            name="addinvoicecommission" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu' id="viewinvoicecommission"
                                                            name="viewinvoicecommission" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu' id="editinvoicecommission"
                                                            name="editinvoicecommission" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu' id="deleteinvoicecommission"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu' id="alldatainvoicecommission"
                                        ...
                                        @if (session('user_permissions.invoicemodule.invoicecommissionparty.edit') == '1' || $user_id == 1)
                                            <tr id="invoicecommissionparty">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='invoicecommissionparty' id="showinvoicecommissionpartymenu"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommissionparty.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionpartymenu' id="addinvoicecommissionparty"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommissionparty.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionpartymenu' id="viewinvoicecommissionparty"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommissionparty.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionpartymenu' id="editinvoicecommissionparty"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommissionparty.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionpartymenu' id="deleteinvoicecommissionparty"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommissionparty.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionpartymenu' id="alldatainvoicecommissionparty"
                                        ...
                                        @if (session('user_permissions.invoicemodule.thirdpartyinvoice.edit') == '1' || $user_id == 1)
                                            <tr id="thirdpartyinvoice">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='thirdpartyinvoice' id="showthirdpartyinvoicemenu"
                                                        name="showthirdpartyinvoicemenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu' id="addthirdpartyinvoice"
                                                            name="addthirdpartyinvoice" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu' id="viewthirdpartyinvoice"
                                                            name="viewthirdpartyinvoice" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu' id="editthirdpartyinvoice"
                                                            name="editthirdpartyinvoice" value="1">
                                                    @else
                                                        -
                                                    @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu' id="deletethirdpartyinvoice"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu' id="alldatathirdpartyinvoice"
                                    ...
                                    <tbody id="hrcheckboxes">
                                        ...
                                        @endif
                                         @if (session('user_permissions.hrmodule.letter_variable_setting.edit') == '1' || $user_id == 1)
                                            <tr id="letter_variable_setting">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='letter_variable_setting'
                                                        id="showletter_variable_settingmenu" name="showletter_variable_settingmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.hrmodule.letter_variable_setting.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showletter_variable_settingmenu' id="addletter_variable_setting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.letter_variable_setting.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showletter_variable_settingmenu' id="viewletter_variable_setting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.letter_variable_setting.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showletter_variable_settingmenu' id="editletter_variable_setting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.letter_variable_setting.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showletter_variable_settingmenu' id="deleteletter_variable_setting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.letter_variable_setting.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showletter_variable_settingmenu' id="alldataletter_variable_setting"
                                        ...
                                        @if (session('user_permissions.hrmodule.generate_letter.edit') == '1' || $user_id == 1)
                                                <tr id="generate_letter">
                                                    ...
                                                    <td>
                                                        <input type="checkbox" class="clickmenu" data-value='generate_letter'
                                                            id="showgenerate_lettermenu" name="showgenerate_lettermenu" value="1">
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.generate_letter.add') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showgenerate_lettermenu' id="addgenerate_letter"
                                                                name="addgenerate_letter" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.generate_letter.view') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showgenerate_lettermenu' id="viewgenerate_letter"
                                                                name="viewgenerate_letter" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.generate_letter.edit') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showgenerate_lettermenu' id="editgenerate_letter"
                                                                name="editgenerate_letter" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.generate_letter.delete') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showgenerate_lettermenu' id="deletegenerate_letter"
                                                                name="deletegenerate_letter" value="1">
                                                        @else
                                                            -
                                                        @endif
                                                    </td>
                                                    <td>
                                                        @if (session('user_permissions.hrmodule.generate_letter.alldata') == '1' || $user_id == 1)
                                                            <input type="checkbox" class="clicksubmenu"
                                                                data-value='showgenerate_lettermenu' id="alldatagenerate_letter"
                                    ...
                                    <tbody id="accountcheckboxes">
                                        ...
                                        @if (session('user_permissions.accountmodule.income.edit') == '1' || $user_id == 1)
                                            <tr id="income">
                                                <td>Income</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='income'
                                                        id="showincomemenu" name="showincomemenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.income.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showincomemenu' id="addincome" name="addincome" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.income.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showincomemenu' id="viewincome" name="viewincome" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.income.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showincomemenu' id="editincome" name="editincome" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.income.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showincomemenu' id="deleteincome" name="deleteincome" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.income.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showincomemenu' id="alldataincome" name="alldataincome" value="1">
                                                    @else - @endif
                                                </td>
                                            </tr>
                                        @endif
                                        ...
                                        @if (session('user_permissions.accountmodule.expense.edit') == '1' || $user_id == 1)
                                            <tr id="expense">
                                                <td>Expense</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='expense'
                                                        id="showexpensemenu" name="showexpensemenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.expense.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showexpensemenu' id="addexpense" name="addexpense" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.expense.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showexpensemenu' id="viewexpense" name="viewexpense" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.expense.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showexpensemenu' id="editexpense" name="editexpense" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.expense.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showexpensemenu' id="deleteexpense" name="deleteexpense" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.expense.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showexpensemenu' id="alldataexpense" name="alldataexpense" value="1">
                                                    @else - @endif
                                                </td>
                                            </tr>
                                        @endif
                                        ...
                                        @if (session('user_permissions.accountmodule.ledger.edit') == '1' || $user_id == 1)
                                            <tr id="ledger">
                                                <td>Ledger</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='ledger'
                                                        id="showledgermenu" name="showledgermenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.ledger.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showledgermenu' id="addledger" name="addledger" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.ledger.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showledgermenu' id="viewledger" name="viewledger" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.ledger.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showledgermenu' id="editledger" name="editledger" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.ledger.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showledgermenu' id="deleteledger" name="deleteledger" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.ledger.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showledgermenu' id="alldataledger" name="alldataledger" value="1">
                                                    @else - @endif
                                                </td>
                                            </tr>
                                        @endif
                                        ...
                                        @if (session('user_permissions.accountmodule.category.edit') == '1' || $user_id == 1)
                                            <tr id="category">
                                                <td>category</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='category'
                                                        id="showcategorymenu" name="showcategorymenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.category.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcategorymenu' id="addcategory" name="addcategory" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.category.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcategorymenu' id="viewcategory" name="viewcategory" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.category.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcategorymenu' id="editcategory" name="editcategory" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.category.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcategorymenu' id="deletecategory" name="deletecategory" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.category.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showcategorymenu' id="alldatacategory" name="alldatacategory" value="1">
                                                    @else - @endif
                                                </td>
                                            </tr>
                                        @endif
                                        @if (session('user_permissions.accountmodule.accountcustomer.edit') == '1' || $user_id == 1)
                                            <tr id="accountcustomer">
                                                <td>Customer</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='accountcustomer'
                                                        id="showaccountcustomermenu" name="showaccountcustomermenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountcustomer.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountcustomermenu' id="addaccountcustomer" name="addaccountcustomer" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountcustomer.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountcustomermenu' id="viewaccountcustomer" name="viewaccountcustomer" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountcustomer.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountcustomermenu' id="editaccountcustomer" name="editaccountcustomer" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountcustomer.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountcustomermenu' id="deleteaccountcustomer" name="deleteaccountcustomer" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountcustomer.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountcustomermenu' id="alldataaccountcustomer" name="alldataaccountcustomer" value="1">
                                                    @else - @endif
                                                </td>
                                            </tr>
                                        @endif
                                        {{-- ── Account Settings expand button ── --}}
                                        @if (session('user_permissions.accountmodule.accountformsetting.edit') == '1' || $user_id == 1)
                                            <tr>
                                                <td class="p-0" style="border-right: 0;">
                                                    <span class="btn expandsettingsbutton" data-target="account_settings_rows">
                                                        <i class="ri ri-2x ri-arrow-right-circle-fill"></i>
                                                        Account Settings
                                                    </span>
                                                </td>
                                        ...
                                        {{-- ── Account Form Setting (sub-row, hidden by default) ── --}}
                                        @if (session('user_permissions.accountmodule.accountformsetting.edit') == '1' || $user_id == 1)
                                            <tr id="accountformsetting" class="account_settings_rows subsettingrows">
                                                <td>Account Form setting</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='accountformsetting'
                                                        id="showaccountformsettingmenu" name="showaccountformsettingmenu" value="1">
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.add') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu' id="addaccountformsetting"
                                                            name="addaccountformsetting" value="1">
                                                    @else - @endif
                                                </td>
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu' id="viewaccountformsetting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu' id="editaccountformsetting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu' id="deleteaccountformsetting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu' id="alldataaccountformsetting"
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        <div class="col-sm-12 text-right">
                                            ...
                                            <button type="button" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Cancel" class="btn btn-secondary cancelbtn">Cancel</button>
                                        </div>
                                    </div>
                                </div>
