...
@section('pdfbtns')
    <div class="col-sm-12 text-right px-4">
        <button id="download-ledger" class="btn btn-sm btn-primary float-left" data-toggle="tooltip" data-placement="bottom"
            data-original-title="Download Ledger">
...
@section('table-content')
    <table id="data" class="dataTable display table table-bordered table-striped w-100">
        ...
        <tfoot>
            <tr>
                <th colspan="4" class="text-end">Total(All Record)</th>
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // fetch & show ledger data in table
            function loaddata() {
                loadershow();
            ...
            //call function for load ledger data in table
            loaddata();
