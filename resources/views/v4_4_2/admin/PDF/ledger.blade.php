...
<body>
    <div class="card">
        ...
        <table>
            <tr>
                <td width="20%">
                    <img 
                        @if ($companyDetails['img'] != '') 
                            src="{{ public_path('uploads/' . $companyDetails['img']) }}" 
                        @endif
                ...
                <td width="80%">
                    <div class="title">{{ $companyDetails['name'] }}</div>
                    <div class="subtitle">
                        Office Address:
                        {!! nl2br(e(wordwrap($companyDetails['house_no_building_name'], 40, "\n", true))) !!},
    ...
    <!-- ✅ PAGE NUMBER (ONLY THIS METHOD) -->
    <script type="text/php">
        if (isset($pdf)) {
            $font = $fontMetrics->getFont("Helvetica", "normal");
            $pdf->page_text(520, 820, "Page {PAGE_NUM} of {PAGE_COUNT}", $font, 10);
        }
    </script>
