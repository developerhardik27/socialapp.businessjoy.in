...
<head>
    ...
    <style>
        ...
        /* Make dropdown responsive with scrollbar */
        #navbarSupportedContent .iq-sub-dropdown {
            max-height: 70vh;
            /* responsive height */
            overflow-y: auto;
        ...
        /* Chrome, Edge, Safari */
        #navbarSupportedContent .iq-sub-dropdown::-webkit-scrollbar {
            width: 6px;
        }

        #navbarSupportedContent .iq-sub-dropdown::-webkit-scrollbar-thumb {
            background: #ccc;
            border-radius: 4px;
        }

        #navbarSupportedContent .iq-sub-dropdown::-webkit-scrollbar-thumb:hover {
            background: #999;
        }
