                                                ...
                                                <div class="col-md-12">
                                                    <div class="profile-img-edit" id="userprofile">
                                                        <div class="p-image">
                                                            ...
                                                            <input type="file" accept="image/*" class="file-upload" id="img"
                                                                name="img">
                                        ...
                                        <form method="POST" id="changepasswordform">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="Password" name="new_password" class="form-control"
                                                    id="new_password">
                                                <span class="error-msg" id="error-new_password" style="color: red"></span>
                                            </div>
                                            <div class="form-group">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.status == 200 && response.company != '') {
                        ...
                        $('#companycontact').text(company.contact_no+' / ' + company.alternative_number);
