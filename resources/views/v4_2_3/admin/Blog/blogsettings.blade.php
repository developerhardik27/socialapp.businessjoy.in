        ...
        <div class="container-fluid">
            <div class="row">
                @if (session('user_permissions.blogmodule.blogsettings.edit') == 1)
                    <div class="col-12">
                        <button data-toggle="tooltip" data-placement="bottom" data-original-title="Edit Blog Details Endpoint"
                            type="button" id="editblogdetailendpoint"
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                <form id="blogdetailsendpointform" style="display: none">
                                    @csrf
                                            ...
                                            <div class="form-row">
                                                <div class="col-sm-12 mt-2">
                                                    <button type="button" data-toggle="tooltip"
                                                        id="blogdetailsendpoint-cancelbtn" data-placement="bottom"
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            $('#editblogdetailendpoint').on('click', function() {
                $(this).toggle();
                $('#blogdetailsendpointform').toggle();
            });


            $('#blogdetailsendpoint-cancelbtn').on('click', function() {
                $('#editblogdetailendpoint').toggle();
                $('#blogdetailsendpointform')[0].reset();
                $('#blogdetailsendpointform').toggle();
            });
            ...
            $('#blogdetailsendpointform').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (res.status === 200) {
                            ...
                            $('#blogdetailsendpointform')[0].reset();
                            $('#blogdetailsendpointform').hide();
                            $('#editblogdetailendpoint').show();
