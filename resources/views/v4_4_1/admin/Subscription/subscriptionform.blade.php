...
@section('page_title')
    {{ config('app.name') }} - Add New Subscription
@endsection
@section('title')
    New Subscription
@endsection
    ...
    <form id="subscriptionform">
        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <!-- Trial Start Date (Default Today) -->
                <div class="col-sm-6 mb-2">
                    <label for="trial_start_date">Trial Start Date</label><span style="color:red;">*</span>
                    <input type="date" name="trial_start_date" class="form-control" id="trial_start_date" required />
                ...
                <div class="col-sm-12 mb-3">
                    <button type="button" class="btn btn-sm btn-outline-primary mr-2 quick-action"
                        data-action="always">
                ...
                <!-- Payment Cycle Start Date (Default = Subscription Start Date) -->
                <div class="col-sm-6 mb-2">
                    <label for="payment_cycle_start_date">Payment Cycle Start Date</label><span style="color:red;">*</span>
                    <input type="date" name="payment_cycle_start_date" class="form-control" id="payment_cycle_start_date"
                        required />
                ...
                <div class="col-sm-12 mt-4">
                    ...
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Save Subscription Details"
                        class="btn btn-primary float-right m-0 mr-2">Save</button>
                </div>
            </div>
        </div>
    </form>
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // Set today's date as default for trial start date
            const today = new Date().toISOString().split('T')[0];
            $('#trial_start_date').val(today);
                        ...
                        if (response.status == 200) {
                            ...
                            $.each(response.company, function(key, company) {
                                ...
                                if(company.subscription_count > 0) {
                                    companydetails += ` - ${company.subscription_count} Active Subscription(s)`;
                                }
            ...
            $('#subscriptionform').submit(function(event) {
                ...
                ajaxRequest('POST', "{{ route('subscription.store') }}", formdata).done(function(response) {
                    if (response.status == 200) {
                        Toast.fire({
                            icon: "success",
