                        ...
                        <td style="text-align: center">
                            ...
                            @php
                                $address = array_filter([
                                    $companydetails['house_no_building_name'] ?? null,
                                    $companydetails['road_name_area_colony'] ?? null,
                                    $companydetails['city_name'] ?? null,
                                    $companydetails['state_name'] ?? null,
                                    $companydetails['pincode'] ?? null,
                                ]);
                            @endphp
