                ...
                <div class="modal-body">
                    <form id="letterForm" enctype="multipart/form-data">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <label for="body_content">Body Content</label><span class="text-danger">*</span>
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                @if (session('user_permissions.hrmodule.letters.view') == '1')
                                    let variableEditUrl =
                                        "{{ route('admin.letterfomateview', '__varId__') }}"
                                    ...
                                    <span>
                                        <a href="${variableEditUrl}">
                                            <button type="button"
                                                ...
                                                data-original-title="Preview  Letter Formate"
