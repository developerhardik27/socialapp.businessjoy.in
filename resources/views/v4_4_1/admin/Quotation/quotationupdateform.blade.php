            ...
            $('document').ready(function() {
                ...
                ajaxRequest('GET', quotationEditUrl, { 
                    ...
                    if (response.status == 200) {  
                        ...
                        third_party_quotation = quotationdetails.third_party_quotation;
                       if (third_party_quotation == 0 || !viewthirdpartycompanies) {
                            $('#company_div').hide();
                            if (viewthirdpartycompanies) companies(); // load without selection
                        } else {
                            companies(quotationdetails.company_id); // ✅ load AND select correct company
                        }
                        $('.select2').select2(); 
