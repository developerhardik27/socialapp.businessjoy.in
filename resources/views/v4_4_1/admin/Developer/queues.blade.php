                ...
                <div class="col-md-12">
                    <div class="card shadow-sm mb-4">
                        <div class="card-header bg-light d-flex justify-content-between align-items-center"
                            style="cursor: pointer;" onclick="toggleSection({{ $index }})">
                            <h6 class="mb-0">
                                <span class="badge bg-primary me-2">Step {{ $index + 1 }}</span>
                                {{ $step['title'] }}
                            </h6>
                            <i class="ri-arrow-down-s-line fs-5" id="toggle-icon-{{ $index }}"></i>
                        </div>

                        <div class="card-body" id="section-content-{{ $index }}"
                            style="display: {{ in_array($index, [4, 9]) ? 'none' : 'block' }};">
