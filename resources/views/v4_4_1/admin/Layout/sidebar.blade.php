                    ...
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        @if (Session::has('menu') && Session::get('menu') == 'invoice')
                            ...
                            @if (session('user_permissions.invoicemodule.thirdpartyinvoice.show') == '1')
                                <li class="{{ request()->routeIs('admin.invoice.thirdpartycompany') ? 'active' : '' }}">
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'quotation')
                            ...
                            @if (session('user_permissions.quotationmodule.thirdpartyquotation.show') == '1')
                                <li class="{{ request()->routeIs('admin.quotation.thirdpartycompany') ? 'active' : '' }}">
                                    <a href="{{ route('admin.quotation.thirdpartycompany') }}" class="iq-waves-effect">
                                        <i class="ri-government-line"></i>
                                        <span>3rd PartyCompany</span>
                                    </a>
                                </li>
