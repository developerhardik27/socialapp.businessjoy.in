                ...
                table = $('#data').DataTable({
                    ...
                    columns: [{
                            ...
                            render: function(data, type, row){
                                ...
                                if (row.customer_type == 'invoice' && menu == 'invoice') {
                                    return `${data} (INV CUS ID: ${row.customer_id})`;
                                }else{
                                    return data;
                                }
                            }
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                @if (session('user_permissions.invoicemodule.customer.view') == '1' ||
                                        session('user_permissions.quotationmodule.quotationcustomer.view') == '1')
                                    return ` 
