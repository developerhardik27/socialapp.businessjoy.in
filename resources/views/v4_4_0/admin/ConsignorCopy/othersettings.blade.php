        ...
        <div class="container-fluid">
            <div class="row">
                @if (session('user_permissions.logisticmodule.watermark.edit') == 1 ||
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">LR Watermark Image Settings</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                ...
                @if (session('user_permissions.logisticmodule.consignmentnotenumbersettings.edit') == 1)
                    <div class="col-md-6">
                        <button data-toggle="tooltip" data-placement="bottom"
                            data-original-title="Where To Start LR Number" type="button"
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">LR Number Settings</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="hidden" value="{{ $company_id }}" name="company_id"
                                                    class="form-control">
                                                <label for="consignment_note_number">LR Number</label>
                                ...
                                LR Number : <span id="startcnn"> </span><br>
                                Current LR Number : <span id="currentcnn"> </span>
                            </div>
                        </div>
                    </div>
                @endif
                @if (session('user_permissions.logisticmodule.logisticothersettings.edit') == 1)
                    <div class="col-md-6">
                        <button data-toggle="tooltip" data-placement="bottom" data-original-title="Edit LR Default Values"
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">LR Default Value</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                ...
                @if (session('user_permissions.logisticmodule.downloadcopysetting.edit') == 1)
                    <div class="col-md-6">
                        <button data-toggle="tooltip" data-placement="bottom"
                            data-original-title="Edit LR Download Copy Setting" type="button"
                        ...
                        <div class="iq-card">
                            <div class="iq-card-header d-flex justify-content-between">
                                <div class="iq-header-title">
                                    <h4 class="card-title">LR Download Copy</h4>
                                </div>
                            </div>
                            <div class="iq-card-body">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" value="{{ $company_id }}" name="company_id"
                                                    class="form-control">
                                                <label for="consignee_dropdown" class="form-label"><b>Consignee Drop Down</b><span style="color: red">*</span></label>

                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="consignee_dropdown[]" value="invoice">
                                                        Invoice
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignee_dropdown[]" value="invoicecommissionparty">
                                                        Invoice Commission Party
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignee_dropdown[]" value="quotation">
                                                        Quotation
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignee_dropdown[]" value="consignee">
                                                        Consignee
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignee_dropdown[]" value="consignor">
                                                        Consignor
                                                    </label>
                                                </div>

                                                <span class="error-msg" id="error-consignee_dropdown" style="color: red"></span>
                                            </div>
                                            <div class="col-md-12"> 
                                                <label for="consignor_dropdown" class="form-label"><b>Consignor Drop Down</b><span style="color: red">*</span></label>
                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="consignor_dropdown[]" value="invoice">
                                                        invoice
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignor_dropdown[]" value="invoicecommissionparty">
                                                        Invoice Commission Party
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignor_dropdown[]" value="quotation">
                                                        Quotation
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignor_dropdown[]" value="consignee">
                                                        Consignee
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="consignor_dropdown[]" value="consignor">
                                                        Consignor
                                                    </label>
                                                </div>

                                                <span class="error-msg" id="error-consignor_dropdown" style="color: red"></span>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-sm-12 mt-2">
                                ...
                                Consignee Drop Down : <span id="consigneedropdownsettings"> </span> <br>
                                Consignor Drop Down : <span id="consignordropdownsettings"> </span>
                            </div>
                        </div>
                    </div>
                @endif
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200 && response.logisticsettings != '') {
                            ...
                            // dropdown code
                            consignee_dropdown = response.logisticsettings['consignee_dropdown'];
                            consignor_dropdown = response.logisticsettings['consignor_dropdown'];

                            let consigneedropdownsettings = JSON.parse(consignee_dropdown);
                            let consignordropdownsettings = JSON.parse(consignor_dropdown);

                            document.querySelectorAll('input[name="consignee_dropdown[]"]').forEach((
                                checkbox) => {
                                $.each(consigneedropdownsettings, function (index, value) {
                            ...
                            document.querySelectorAll('input[name="consignor_dropdown[]"]').forEach((
                                checkbox) => {
                                $.each(consignordropdownsettings, function (index, value) {
                                    if (value === checkbox.value) {
                                        checkbox.checked = true;
                                    }
                                });  
                            ...
                            $('#consigneedropdownsettings').html(`<b>${consigneedropdownsettings.join(', ')}</b> `);
                            $('#consignordropdownsettings').html(`<b>${consignordropdownsettings.join(', ')}</b> `);
                            ...
                            if (response.lrcount > 0) {
                                $('#info-consignment_note_no').text(
                                    `LR number not allow to smaller than ${othersettings.current_consignment_note_no}`
                                    );
                            }
