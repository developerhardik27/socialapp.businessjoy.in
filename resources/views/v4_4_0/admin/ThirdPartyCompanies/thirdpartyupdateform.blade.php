        ...
        <div class="form-group">
            <div class="form-row">
                ...
                <div class="col-sm-6 mb-2">
                    ...
                    <p class="text-primary mb-0">Please select a photo file (JPG, JPEG, or PNG) that is smaller than 1 MB.
                    </p>
                    <p class="text-primary">Upload a logo with space around all four sides for a better visual effect.</p>
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            let companySearchUrl = "{{ route('quotation.company.search', '__editId__') }}".replace('__editId__',
                edit_id);
            $.ajax({
                type: 'GET',
            ...
            $('#cancelbtn').on('click', function() {
                loadershow();
                window.location.href = "{{ route('admin.quotation.thirdpartycompany') }}";
            });
            ...
            $('#companyupdateform').submit(function(event) {
                ...
                let companyUpdateUrl = "{{ route('quotation.company.update', '__editId__') }}".replace(
                    '__editId__', edit_id);
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            window.location = "{{ route('admin.quotation.thirdpartycompany') }}";
