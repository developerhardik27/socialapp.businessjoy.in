        ...
        <main>
            <div class="content">
                    ...
                    <tr>
                        ...
                        <td class="vertical-align-center">
                            ...
                            @if ($companydetails['contact_no'])
                                <p>
                                    <b>Contact :</b> {{ $companydetails['contact_no'] }} @if ($companydetails['alternative_number'] != null && $companydetails['alternative_number'] != '')
                                        / {{ $companydetails['alternative_number'] }}
                                    @endif
                                </p>
                            @endif
                ...
                <table class="w-100 table">
                    ...
                    <tr>
                        <td colspan="3">
                            <b>GST Tax Payable By :
                            </b><span>{{ strtoupper($consignorcopy['gst_tax_payable_by']) }}</span>
                        </td>
                    </tr>
                </table>
