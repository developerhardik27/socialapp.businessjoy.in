        ...
        $('document').ready(function() {
            ...
            $(document).on("click", '.hide-btn', function() {
                ...
                showConfirmationDialog(
                    'Are you sure?',  // Title
                    'you want to Update this Column?', // Text
            ...
            $('#columnform').submit(function(e) {
                ...
                if (editid != '') {
                    showConfirmationDialog(
                        'Are you sure?',  // Title
                        'Edited column name will reflect in relevant quotations. still you want to apply this?', // Text
                    ...
                    showConfirmationDialog(
                        'Are you sure?',  // Title
                        'You want to add this Column?', // Text
