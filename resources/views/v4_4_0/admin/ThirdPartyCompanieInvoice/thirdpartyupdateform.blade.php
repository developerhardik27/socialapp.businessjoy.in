...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            let companySearchUrl = "{{ route('invoice.company.search', '__editId__') }}".replace('__editId__',
                edit_id);
            $.ajax({
                type: 'GET',
            ...
            $('#companyupdateform').submit(function(event) {
                ...
                let companyUpdateUrl = "{{ route('invoice.company.update', '__editId__') }}".replace(
                    '__editId__', edit_id);
                $.ajax({
                    type: 'POST',
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            window.location = "{{ route('admin.invoice.thirdpartycompany') }}";
