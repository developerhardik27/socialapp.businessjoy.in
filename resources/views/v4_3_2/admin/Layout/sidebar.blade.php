                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'logistic')
                            ...
                            @endif
                            @if (session('user_permissions.logisticmodule.logisticsettings.show') == '1' || session('user_permissions.logisticmodule.lrcolumnmapping.show') == '1')
                                <li class="{{ request()->routeIs('admin.logisticothersettings', 'admin.lrcolumnmapping') ? 'active' : '' }}">
                                    ...
                                    <ul id="logisticsettinginfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                        @if (session('user_permissions.logisticmodule.lrcolumnmapping.show') == '1')
                                            <li class="{{ request()->routeIs('admin.lrcolumnmapping', 'lrcolumnmapping') ? 'active' : '' }}">
