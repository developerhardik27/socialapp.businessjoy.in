            ...
            function loaddata() {
                ...
                table = $('#data').DataTable({
                    ...
                    drawCallback: function(settings) {
                        ...
                        $('#totalCredit').html(json.totalCredited);
                        $('#totalDebit').html(json.totalDebited);

                        let totalBalance = parseFloat(json.totalBalance.replace(/,/g, ''));
                        let balColor = totalBalance >= 0 ? 'text-success' : 'text-danger';
                       
                        $('#totalBalance').html(
                            `<span class="${balColor}">${json.totalBalance}</span>`
                        );
