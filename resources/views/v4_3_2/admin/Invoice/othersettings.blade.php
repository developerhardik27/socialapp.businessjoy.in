                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-sm-12 mb-2">
                                                ...
                                                <input type="hidden" value="{{ $company_id }}" name="company_id"
                                                    class="form-control">
                                                <label for="customer_dropdown"><b>Customer Drop Down</b><span style="color: red">*</span></label>

                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]" value="invoice">
                                                        Invoice
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]" value="invoicecommissionparty">
                                                        Invoice Commission Party
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]" value="quotation">
                                                        Quotation
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]" value="consignor">
                                                        Consignors
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]" value="consignee">
                                                        Consignees
                                                    </label>
                                                </div>  
                                            ...
                                            <div class="col-sm-12"> 
                                                <label for="invoice_commission_party_dropdown"><b>Invoice Commission Party Drop Down</b><span style="color: red">*</span></label>

                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]" value="invoice">
                                                        invoice
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]" value="invoicecommissionparty">
                                                        Invoice Commission Party
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]" value="quotation">
                                                        Quotation
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]" value="consignor">
                                                        Consignors
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]" value="consignee">
                                                        Consignees
                                                    </label>
                                                </div>  
    ...
    <script>
        $('document').ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200 && response.overdueday != '') {
                            ...
                            document.querySelectorAll('input[name="invoice_commission_party_dropdown[]"]').forEach((
                                checkbox) => {
                            ...
                            $('#invoicecommissionpartydropdown').html(`<b>${commission_party_dropdown_list.join(', ')}</b>`);
                            ...
                            if (commission == 1) {
                                ...
                                $('#commissiondisabledswitch').prop('checked', true); // Check the checkbox
                            } else {
                                $('#commissionswitch').prop('checked', false); // Uncheck the checkbox
                                $('#commissiondisabledswitch').prop('checked', false); // Uncheck the checkbox
                            }
            ...
            $('#commissionform').submit(function(event) {
                ...
                let commissionSettingsUpdateUrl = "{{ route('commissionsettingsupdate.update', '__editId__') }}".replace(
                    '__editId__', editid);
                $('.error-msg').text('');
                const formdata = $(this).serialize();
                $.ajax({
