...
@if (session('user_permissions.quotationmodule.thirdpartyquotation.add') == '1')
    @section('addnew')
        {{ route('admin.quotation.addthirdpartycompany') }}
    @endsection
        ...
        $('document').ready(function() {
            ...
            function loaddata() {
                ...
                table = $('#data').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ route('quotation.company.index') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                @if (session('user_permissions.quotationmodule.thirdpartyquotation.edit') == '1')
                                    if (data == 1) {
                                        actionBtns += `
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                @if (session('user_permissions.quotationmodule.thirdpartyquotation.edit') == '1')
                                    var editCompanyUrl =
                                        "{{ route('admin.quotation.editthirdpartycompany', '__companyId__') }}"
                                        .replace(
                                            '__companyId__', data);
                                    actionBtns += ` 
                                    ...
                                    `;
                                @endif
                                @if (session('user_permissions.quotationmodule.thirdpartyquotation.delete') == '1')
                                    actionBtns += ` 
            ...
            function chanecompanystatus(companyid, statusvalue) {
                let companyStatusUpdateUrl = "{{ route('quotation.company.statusupdate', '__companyId__') }}"
            ...
            $(document).on("click", ".del-btn", function() {
                ...
                showConfirmationDialog(
                    ...
                    () => {
                        // Success callback
                        loadershow();
                        let companyDeleteUrl = "{{ route('quotation.company.delete', '__deleteId__') }}".replace(
