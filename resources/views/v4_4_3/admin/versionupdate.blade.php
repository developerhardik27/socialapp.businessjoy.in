                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select class="form-control" id="version" name="version" required>
                                                ...
                                                <option value="v4_3_1">V4.3.1</option>
                                                <option value="v4_3_2">V4.3.2</option>
                                                <option value="v4_4_0">V4.4.0</option>
                                                <option value="v4_4_1">V4.4.1</option>
                                                <option value="v4_4_2">V4.4.2</option>
                                                <option value="v4_4_3">V4.4.3</option>
                                                <option value="v4_4_4">V4.4.4</option>
                                            </select>
