                        ...
                        <ul id="topbar-data-icon" class="d-flex p-0 topbar-menu-icon">
                            ...
                            @if (session('menu') == 'logistic')
                                ...
                                @if (session('user_permissions.logisticmodule.transporterbilling.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.transporterbilling') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-bill-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Transporter Bills"></i>
                                        </a>
                                    </li>
                                @endif
                            @endif
                            @if (session('menu') == 'hr')
                                @if (session('user_permissions.hrmodule.employees.show') == '1')
                                    <li>
                                        ...
                                        <a href="{{ route('admin.employee') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-user-star-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Employee List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.hrmodule.companiesholidays.show') == '1')
                                    <li>
                                        ...
                                        <a href="{{ route('admin.holidays') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-sun-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title=" Holidays List"></i>
                                        </a>
                                    ...
                                    <li>
                                        ...
                                        <a href="{{ route('admin.calendar') }}"
                                            ...
                                            <i class="ri-calendar-event-line" data-toggle="tooltip"
                                                data-placement="bottom"
                                                data-original-title=" calendar Event List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.hrmodule.letters.show') == '1')
                                    <li>
                                        ...
                                        <a href="{{ route('admin.letter') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-file-list-3-line" data-toggle="tooltip"
                                                data-placement="bottom"
                                                data-original-title="Letter Formates List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.hrmodule.letter_variable_setting.show') == '1')
                                    <li>
                                        {{-- {{ route('admin.letter') }} --}}
                                        <a href="{{ route('admin.letter_variable_setting') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-file-list-3-line" data-toggle="tooltip"
                                                data-placement="bottom"
                                                data-original-title="Letter Variable Setting List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.hrmodule.generate_letter.show') == '1')
                                    <li>
                                        {{-- {{ route('admin.letter') }} --}}
                                        <a href="{{ route('admin.generateletter') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-file-edit-line" data-toggle="tooltip"
                                                data-placement="bottom"
                                                data-original-title="Generate Letter List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.accountmodule.income.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.income') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-wallet-3-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="Income List"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.accountmodule.expense.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.expense') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-bank-card-line" data-toggle="tooltip"
                                                data-placement="bottom" data-original-title="Expense List"></i>
                                        </a>
                                ...
                                @if (session('user_permissions.accountmodule.ledger.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.ledger') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-book-3-line" data-toggle="tooltip" data-placement="bottom"
                                                data-original-title="ledger"></i>
                                        </a>
                                    </li>
                                @endif
                                @if (session('user_permissions.accountmodule.category.show') == '1')
                                    <li>
                                        <a href="{{ route('admin.category') }}"
                                            class="nav-link router-link-exact-active router-link-active">
                                            <i class="ri-list-check" data-toggle="tooltip" data-placement="bottom"
                                    ...
                                    <div class="iq-sub-dropdown">
                                        ...
                                        @if (Session::has('tea') && Session::get('tea') == 'yes')
                                            <a class="iq-sub-card changemenu" href="#" data-value="tea">
                                                <i class="ri-article-line"></i>Tea</a>
                                        @endif
