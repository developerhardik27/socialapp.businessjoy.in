...
@section('page_title')
    {{ config('app.name') }} - LR-Invoice Mapping
@endsection
                    ...
                    <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title float-left col-auto">
                                <h4 class="card-title">LR-Invoice Mapping</h4>
                            </div>
                                    ...
                                    <div id="newColForm" class="form-row d-none">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select name="lr_column" class="form-control " id="lr_column">
                                                ...
                                                <option value="weight_type">Weight Unit</option>
                                                <option value="actual">Actual Weight</option>
                                                <option value="charged">Charged Weight</option>
                                                ...
                                                <option value="be_inv_no">BE / INV NO.</option>
                                                <option value="port">PORT</option>
                                                <option value="pod">POD</option>
                                                <option value="service">Service</option>
                                                <option value="sac_code">SAC CODE</option>
                                                <option value="from">From - To - To</option>
                                            </select>
