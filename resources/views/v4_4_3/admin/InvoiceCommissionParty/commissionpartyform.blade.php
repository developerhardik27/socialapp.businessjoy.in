...
@section('page_title')
    {{ config('app.name') }} - Add New Commission Party
@endsection
@section('title')
            ...
            <div class="form-row">
                ...
                <div class="col-sm-12">
                    ...
                    <button type="reset" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Reset Commission Party Details"
                        class="btn iq-bg-danger float-right mr-2">Reset</button>
                    <button type="submit" data-toggle="tooltip" data-placement="bottom"
                        data-original-title="Save Commission Party Details" class="btn btn-primary float-right my-0">Save</button>
                </div>
            </div>
        </div>
    </form>
...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // Commission Party form  -> dynamic required attribute (if enter company name then only company name required otherwise only firstname)
            $('.withgstspan').hide();
            ...
            // redirect on Commission Party list page on click cancel btn
            $('#cancelbtn').on('click', function() {
                loadershow();
                window.location.href = "{{ route('admin.invoicecommissionparty') }}";
            });

            // submit invoice commission party form 
            $('#commissionpartyform').submit(function(event) {
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            window.location.href =
                                "{{ route('admin.invoicecommissionparty') }}"; // redirect on Commission Party list page
