            ...
            $('document').ready(function () {
                 ...
                 function companies(companyid = 0) { 
                    ...
                    ajaxRequest('GET', "{{ route('invoice.companylist') }}", { 
                        ...
                        if (response.status == 200 && response.company != '') {
                           ...
                           if (companyid != 0) {
                                $('#company').val(companyid); // ✅ set after options are loaded
                            }
                            ...
                            $('#comapny').append(`<option disabled '>No Data found </option>`);
                        }
                        loaderhide();                   
                    }).fail(function(xhr) {
                        loaderhide();
                ...
                ajaxRequest('GET', invoiceEditUrl, {
                    ...
                    if (response.status == 200) {
                        ...
                        console.log(invdetails,productdetails);
                        ...
                        bankdetails__invoice = invdetails.third_party_invoice;
                        ...
                        third_party_invoice = invdetails.third_party_invoice;
                       if (third_party_invoice == 0 || !viewthirdpartycompanies) {
                            $('#company_div').hide();
                            if (viewthirdpartycompanies) companies(); // load without selection
                        } else {
                            companies(invdetails.company_id); // ✅ load AND select correct company
                        }
