...
@push('ajax')
    <script>
        $('document').ready(function() {
            ...
            // load category 
            function loadCategory(selectedId = '') {
                loadershow(); // Show loader
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        if (selectedId) {
                            loadsubCategory(selectedId);
                        } else {
                            $('#expense_subcategory').html(`<option value="">Select category</option>`)
                                .select2({
                                    placeholder: 'Select category',
                                    allowClear: true
                                });
            ...
            $('#expense_subcategory').on('change', function() {
                ...
                if (val == 'add_new') {
                    ...
                    $('#sub_category_parent_id').val(parentCategoryId); // ✅ pre-fill hidden field
            ...
            $('#category_cancelBtn').on('click', function() {
                ...
                $('#expense_category').val('').trigger('change'); // ✅ correct ID + select2 reset
            ...
            $('#subcategory_cancelBtn').on('click', function() {
                ...
                $('#expense_subcategory').val('').trigger('change'); // ✅ correct ID + select2 reset
            ...
            function loadPaidTo(selectedId = '') {
                ...
                ajaxRequest('GET', "{{ route('customer.accountexpensecustomer') }}", {
                    ...
                    if (response.status == 200 && response.data != '') {
                        ...
                        $('#paid_to').append(`<option disabled>No Padi To Found</option>`);
                    }
            ...
            // ── paid to (customer) add model  Cancel button ────────────────────────────────────────────────────────────
