...
@push('ajax')
    <script>
        ...
        $('document').ready(function() {
                    ...
                    render: function(data, type, row) {
                        ...
                        @if (session('user_permissions.invoicemodule.invoice.edit') == '1')
                           if (row.is_editable == 1) {
                                if (row.third_party_invoice == 1) {
                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.view') == '1')
                                        let invoiceEditUrlThird = "{{ route('admin.editinvoice', '__invoiceId__') }}"
                                            .replace('__invoiceId__', row.id);
                                        actionBtns += `
                                            <span>  
                                                <a href=${invoiceEditUrlThird}>
                                                    <button type="button" data-id='${row.id}' data-toggle="tooltip" 
                                                        data-placement="bottom" data-original-title="Edit Invoice" 
                                    ...
                                    @else
                                        actionBtns += `
                                            <span>  
                                                <button type="button" data-id='${row.id}' data-toggle="tooltip" 
                                                    data-placement="bottom" data-original-title="Edit Invoice" 
                                                    class="no-permission-btn btn btn-success btn-rounded btn-sm my-0">
                                                    <i class="ri-edit-fill"></i>
                                                </button>
                                            </span>
                                        `;
                                    ...
                                    let invoiceEditUrl = "{{ route('admin.editinvoice', '__invoiceId__') }}"
                                        .replace('__invoiceId__', row.id);
                                    actionBtns += `
                                        <span>  
                        ...
                        @endif
                        if (row.company_details_id != global_response.company_details_id && row.third_party_invoice != 1)  {
                            actionBtns += `
                                <span>
                            ...
                            if (row.third_party_invoice == 1) {
                                @if (session('user_permissions.invoicemodule.thirdpartyinvoice.view') == '1')
                                    actionBtns += `
                                        <span>
                                            <button type="button" data-id='${row.id}' data-toggle="tooltip" 
                                                data-placement="bottom" data-original-title="Delete Invoice" 
                                ...
                                @else
                                    actionBtns += `
                                        <span>
                                            <button type="button" data-id='${row.id}' data-toggle="tooltip" 
                                                data-placement="bottom" data-original-title="Delete Invoice" 
                                                class="no-permission-delete-btn btn btn-danger btn-rounded btn-sm my-0">
                                                <i class="ri-delete-bin-fill"></i>
                                            </button>
                                        </span>
                                    `;
            ...
            loaddata();
            $(document).on('click', '.no-permission-btn', function () {
                Swal.fire({
                    icon: 'warning',
                    title: 'Permission Denied',
                    text: 'You do not have third party company permission. Please set all permissions so that you can edit this invoice.',
                    confirmButtonText: 'OK'
                });
            });
            $(document).on('click', '.no-permission-delete-btn', function () {
                Swal.fire({
                    icon: 'warning',
                    title: 'Permission Denied',
                    text: 'You do not have third party company permission. Please set all permissions so that you can delete this invoice.',
                    confirmButtonText: 'OK'
                });
            });
            // record delete 
            ...
            function commissionForm(formtitle, invid = null, partyid = null, commissionid = null, commission = null) {
                $('#commissionmodalTitle').html(`<b>${formtitle} Commission</b>`);
            ...
            function newCommissionPartyForm() {
                $('#commissionmodalTitle').html(`<b>Add New Commission Party</b>`);
                $('#custom-modal-content').html(`
                    ...
                    success: function(response) {
                        if (response.status == 200 & response.invoicecommission != '') {
                            ...
                            $.each(commission, function(key, value) {
                                ...
                                let partyDetails = [value.firstname, value.lastname, value.company_name]
                                    .filter(Boolean).join(' - ');
                                ...
                                if (editCommission) {
                                    editCommissionBtn = `
                                        <button type="button" 
                                            class="btn btn-sm btn-success mr-1 edit-commission-btn"
                                            style="border-radius:4px;"
                                            data-commissionid="${value.id}" 
                                            data-invid="${value.invoice_id}">
                                ...
                                if (deleteCommission) {
                                    deleteCommissionBtn = `
                                        <button type="button" 
                                            class="btn btn-sm btn-danger delete-commission-btn"
                                            style="border-radius:4px;"
                                            data-commissionid="${value.id}" 
                                            data-invid="${value.invoice_id}">
                                ...
                                commissionHtml += `
                                    <tr id="${recordId}" class="commission-item" data-key="${key}">
                                        <td style="padding:15px;">
                                            
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    <b>Commission Party:</b> ${partyDetails}
                                                </div>
                                                <div>
                                                    ${editCommissionBtn}
                                                    ${deleteCommissionBtn}
                                            ...
                                            <div>
                                                <small>${value.created_at_formatted}</small>
                                            </div>
                            ...
                            `;
                            $('#commissionmodalTitle').html(`<b>${invoiceNo} - View Commissions</b>`);
