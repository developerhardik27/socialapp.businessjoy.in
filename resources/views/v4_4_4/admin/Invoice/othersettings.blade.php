    ...
    <div id="content-page" class="content-page ">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                    <table id="data"
                                        class="table  table-bordered display table-responsive-sm table-responsive-md table-responsive-lg  table-striped text-center">
                                        <thead>
                                            <tr>
                                                <th>Sr</th>
        ...
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="iq-card-body" id="appendform">
                                <form id="overduedaysform" style="display: none">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            {{-- IMPORTANT: hidden input must be OUTSIDE the switch wrapper --}}
                                            <input type="hidden" name="third_party_invoice" value="0">

                                            <div class="custom-control custom-switch custom-switch-text custom-control-inline">
                                                <div class="custom-switch-inner">
                                                    <p class="mb-0">
                                                        <input type="checkbox" name="third_party_invoice"
                                                            class="custom-control-input" id="thirdpartyinvoiceswitch"
                                                            value="1">
                                                        <label class="custom-control-label" for="thirdpartyinvoiceswitch"
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            {{-- IMPORTANT: hidden input must be OUTSIDE the switch wrapper --}}
                                            <input type="hidden" name="bankdetails" value="0">

                                            <div class="custom-control custom-switch custom-switch-text custom-control-inline">
                                                <div class="custom-switch-inner">
                                                    <p class="mb-0">
                                                        <input type="checkbox" name="bankdetails"
                                                            class="custom-control-input" id="bankdetailsswitch"
                                                            value="1">
                                                        <label class="custom-control-label" for="bankdetailsswitch"
                                                            data-on-label="Show" data-off-label="Hide">
                                                        </label>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <span id="godname">
                                    <div class="custom-control custom-switch custom-control-inline">
                                        ...
                                        <label class="custom-control-label" for="god_namedisabledswitch" id="god_namelabel">
                                            Show
                                        </label>
                                    </div>
                                </span><br>
                                Third Party invoice : <span id="viewthirdpartyinvoice">
                                    <div class="custom-control custom-switch custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" disabled=""
                                            id="thirdpartyinvoicedisabledswitch">
                                        <label class="custom-control-label" for="thirdpartyinvoicedisabledswitch" 
                                            id="thirdpartyinvoicelabel">inactive</label>  {{-- default inactive --}}
                                    </div>
                                </span><br>
                                Bank Details : <span id="viewbankdetails">
                                    <div class="custom-control custom-switch custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" disabled=""
                                            id="bankdetailsdisabledswitch">
                                        <label class="custom-control-label" for="bankdetailsdisabledswitch" 
                                            id="bankdetailslabel">inactive</label>  {{-- default inactive --}}
                                    </div>
                                </span><br>
                            </div>
                        </div>
                ...
                @if (session('user_permissions.invoicemodule.invoicecommissionsetting.edit') == 1)
                    <div class="col-md-6">
                        <button data-toggle="tooltip" data-placement="bottom"
                            data-original-title="Edit Commission Settings" type="button" id="editcommission"
                            class="float-right m-4 btn btn-outline-success btn-rounded btn-sm my-0">
                            <i class="ri-edit-fill"></i>
                        </button>
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body" id="commissionappendform">
                                <form id="commissionform" style="display: none">
                                    @csrf
                                    <input type="hidden" name="token" value="{{ session('api_token') }}">
                                    <input type="hidden" name="user_id" value="{{ $user_id }}">
                                    <input type="hidden" name="company_id" value="{{ $company_id }}">
                                    <input type="hidden" name="commission_edit_id" id="commission_edit_id">
                                    <div class="form-row">
                                        <div class="col-sm-6 mb-2 mt-4">
                                            Commission :
                                            <div
                                                class="custom-control custom-control-inline custom-switch custom-switch-text d-inline">
                                                <input type="checkbox" class="custom-control-input" id="commissionswitch"
                                                    name="commission" value="1">
                                                <label class="custom-control-label" for="commissionswitch"
                                                    data-on-label="On" data-off-label="Off"></label>
                                            </div>
                                            <p class="error-msg" id="error-commission" style="color: red"></p><br>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-sm-12 mt-2">
                                                <button type="button" id="commission-cancelbtn" data-toggle="tooltip"
                                                    data-placement="bottom" data-original-title="Cancel"
                                                    class="btn btn-secondary float-right">Cancel</button>
                                                <button type="reset" data-toggle="tooltip" data-placement="bottom"
                                                    data-original-title="Reset"
                                ...
                                Commission :
                                <span id="viewcommission">
                                    <div class="custom-control custom-switch custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" disabled=""
                                            checked="" id="commissiondisabledswitch">
                                        <label class="custom-control-label" for="commissiondisabledswitch">On</label>
                                    </div>
                                </span> <br>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col-sm-12 mb-2">
                                                ...
                                                <input type="hidden" value="{{ $company_id }}" name="company_id"
                                                    class="form-control">
                                                <label for="customer_dropdown"><b>Customer Drop Down</b><span
                                                        style="color: red">*</span></label>

                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]"
                                                            value="invoice">
                                                        Invoice
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]"
                                                            value="invoicecommissionparty">
                                                        Invoice Commission Party
                                                    </label>
                                                    <label>
                                                        <input type="checkbox" name="customer_dropdown[]"
                                                            value="quotation">
                                                ...
                                                <span class="error-msg" id="error-customer_dropdown"
                                                    style="color: red"></span>
                                            </div>
                                            <div class="col-sm-12">
                                                <label for="invoice_commission_party_dropdown"><b>Invoice Commission Party
                                                        Drop Down</b><span style="color: red">*</span></label>

                                                <div class="checkbox-group">
                                                    <label>
                                                        <input type="checkbox" name="invoice_commission_party_dropdown[]"
                                                            value="invoice">
                                                        invoice
                                                    </label>
                                                    <label>
                                                ...
                                                <span class="error-msg" id="error-invoice_commission_party_dropdown"
                                                    style="color: red"></span>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                ...
                                Customer Drop Down : <span id="customerdropdown"> </span> <br>
                                Invoice Commission party Drop Down : <span id="invoicecommissionpartydropdown"> </span>
                            </div>
                        </div>
                    </div>
                @endif
...
@push('ajax')
    ...
    <script>
        $('document').ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200 && response.overdueday != '') {
                            ...
                            commission_party_dropdown = data['commission_party_dropdown'];
                            third_party_invoice = data['third_party_invoice'];
                            bankdetails = data['bankdetails'];

                            let customer_dropdown_list = JSON.parse(customer_dropdown);
                            let commission_party_dropdown_list = JSON.parse(commission_party_dropdown);

                            document.querySelectorAll('input[name="customer_dropdown[]"]').forEach((
                                checkbox) => {
                                $.each(customer_dropdown_list, function(index, value) {
                            ...
                            document.querySelectorAll(
                                'input[name="invoice_commission_party_dropdown[]"]').forEach((
                                checkbox) => {
                                $.each(commission_party_dropdown_list, function(index, value) {
                                    if (value === checkbox.value) {
                                        checkbox.checked = true;
                                    }
                                });
                            ...
                            $('#customerdropdown').html(`<b>${customer_dropdown_list.join(', ')}</b>`);
                            $('#invoicecommissionpartydropdown').html(
                                `<b>${commission_party_dropdown_list.join(', ')}</b>`);
                            ...
                            $('#commission_edit_id').val(data['id']);

                            if (commission == 1) {
                                $('#commissionswitch').prop('checked', true); // Check the checkbox
                                $('#commissiondisabledswitch').prop('checked',
                                    true); // Check the checkbox
                            } else {
                                $('#commissionswitch').prop('checked', false); // Uncheck the checkbox
                                $('#commissiondisabledswitch').prop('checked',
                            ...
                            if (god_name == 1) {
                                ...
                                $('#god_namedisabledswitch').prop('checked',
                                    true); // Check the checkbox
                                $('#god_namelabel').text('Show');
                            } else {
                                $('#godnameswith').prop('checked', false); // Uncheck the checkbox
                                $('#god_namedisabledswitch').prop('checked',
                                    false); // Uncheck the checkbox
                                $('#god_namelabel').text('Hide');
                            }
                            if (third_party_invoice == 1) {
                                $('#thirdpartyinvoiceswitch').prop('checked', true);
                                $('#thirdpartyinvoicedisabledswitch').prop('checked', true);
                                $('#thirdpartyinvoicelabel').text('Active');    // ✅ update label text
                            } else {
                                $('#thirdpartyinvoiceswitch').prop('checked', false);
                                $('#thirdpartyinvoicedisabledswitch').prop('checked', false);
                                $('#thirdpartyinvoicelabel').text('Inactive');  // ✅ update label text
                            }
                            if (bankdetails == 1) {
                                $('#bankdetailsswitch').prop('checked', true);
                                $('#bankdetailsdisabledswitch').prop('checked', true);
                                $('#bankdetailslabel').text('Show');    // ✅ update label text
                            } else {
                                $('#bankdetailsswitch').prop('checked', false);
                                $('#bankdetailsdisabledswitch').prop('checked', false);
                                $('#bankdetailslabel').text('Hide');  // ✅ update label text
                            }
                            if (invoice_number == 1) {
                            ...
                            $('#customer_id').val(`${data.current_customer_id}</b>`);
                            $('#startcid').html(`<b>${data.current_customer_id}</b>`);
                            ...
                            $('#customerdropdown').html(`<b>Not set</b>`);
                            $('#invoicecommissionpartydropdown').html(`<b>Not set</b>`);
                            $('#noofblankrows').html(`<b>Not set</b>`);
                            $('#overduedays').html(`<b>Not set</b> `);
                            $('#yearstartdate').html(`<b>Not set</b>`);
                            $('#viewsgst').html(`<b>Not set</b>`);
                            $('#viewcgst').html(`<b>Not set</b>`);
                            $('#godnamestatus').html(`<b>Not set</b>`);
                            $('#startcid').html(`<b>Not set</b>`);
                            $('#gstdisabledswitch').prop('checked', false); // Uncheck the checkbox
                            $('#god_namedisabledswitch').prop('checked', false); // Uncheck the checkbox
                            $('#commissiondisabledswitch').prop('checked',
                                false); // Uncheck the checkbox
                            $('#manualinvnumberswitch').prop('checked', false); // Uncheck the checkbox
                            $('#manualinvdateswitch').prop('checked', false); // Uncheck the checkbox
                            $('#thirdpartyinvoicedisabledswitch').prop('checked',
                                    false);
                            $('#bankdetailsdisabledswitch').prop('checked',
                                    false);
                        }
                        loaderhide();
            ...
            /*
             * commission settings code start
             */
            ...
            // hide overdue day and year start from settings form on click othersetting-cancelbtn
            $('#commission-cancelbtn').on('click', function() {
                $('#editcommission').show();
                $('#commissionform').hide();
            ...
            $('#commissionform').submit(function(event) {
                event.preventDefault();
                loadershow();
                editid = $('#commission_edit_id').val();
                let commissionSettingsUpdateUrl =
                    "{{ route('commissionsettingsupdate.update', '__editId__') }}".replace(
                        '__editId__', editid);
                $('.error-msg').text('');
                const formdata = $(this).serialize();
                $.ajax({
                    type: 'POST',
                    url: commissionSettingsUpdateUrl,
                    data: formdata,
                    success: function(response) {
                        // Handle the response from the server
                        if (response.status == 200) {
