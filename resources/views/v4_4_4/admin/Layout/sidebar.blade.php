                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        ...
                        @if (Session::has('menu') && Session::get('menu') == 'invoice')
                            ...
                            @endif
                            @if (session('user_permissions.invoicemodule.invoicecommissionparty.show') == '1')
                                <li class="{{ request()->routeIs('admin.invoicecommissionparty') ? 'active' : '' }}">
                                    <a href="{{ route('admin.invoicecommissionparty') }}" class="iq-waves-effect">
                                        <i class="ri-group-line"></i>
                                        <span>Commission Party</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.invoicemodule.thirdpartyinvoice.show') == '1')
                                <li
                                    class="{{ request()->routeIs('admin.invoice.thirdpartycompany') ? 'active' : '' }}">
                                    <a href="{{ route('admin.invoice.thirdpartycompany') }}" class="iq-waves-effect">
                                        <i class="ri-government-line"></i>
                                        <span>3rd PartyCompany</span>
                                    </a>
                                </li>
                            @endif
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'quotation')
                            ...
                            @if (Session::has('menu') && Session::get('menu') == 'quotation')
                                ...
                                @endif
                            @endif
                            @if (session('user_permissions.quotationmodule.thirdpartyquotation.show') == '1')
                                <li
                                    class="{{ request()->routeIs('admin.quotation.thirdpartycompany') ? 'active' : '' }}">
                                    <a href="{{ route('admin.quotation.thirdpartycompany') }}"
                        ...
                        @elseif(Session::has('menu') && Session::get('menu') == 'admin')
                            ...
                            @endif
                            @if (session('admin_role') == 1)
                                <li class="{{ request()->routeIs('admin.parentcompany') ? 'active' : '' }}">
                                    <a href="{{ route('admin.parentcompany') }}" class="iq-waves-effect">
                                        <i class="ri-parent-line"></i>
                                        <span>Parent Company</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.adminmodule.package.show') == '1')
                                <li class="{{ request()->routeIs('admin.package') ? 'active' : '' }}">
                                    <a href="{{ route('admin.package') }}" class="iq-waves-effect">
                                        <i class="ri-stack-line"></i>
                                        <span>Package</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.adminmodule.subscription.show') == '1')
                                <li class="{{ request()->routeIs('admin.subscription') ? 'active' : '' }}">
                                    <a href="{{ route('admin.subscription') }}" class="iq-waves-effect">
                                        <i class="ri-list-check-2"></i>
                                        <span>Subscription</span>
                                    </a>
                                </li>
                                <li class="{{ request()->routeIs('admin.subscriptionpayments') ? 'active' : '' }}">
                                    <a href="{{ route('admin.subscriptionpayments') }}" class="iq-waves-effect">
                        ...
                        @elseif(Session::has('menu') && Session::get('menu') == 'hr')
                            ...
                            @if (session('user_permissions.hrmodule.companiesholidays.show') == '1')
                                <li class="{{ request()->routeIs('admin.holidays') ? 'active' : '' }}">
                                    <a href="{{ route('admin.holidays') }}" class="iq-waves-effect">
                            ...
                            @if (session('user_permissions.hrmodule.letters.show') == '1')
                                <li class="{{ request()->routeIs('admin.letter') ? 'active' : '' }}">
                                    <a href="{{ route('admin.letter') }}" class="iq-waves-effect">
                                        ...
                                        <span>Letter Formate</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.hrmodule.letter_variable_setting.show') == '1')
                                <li
                                    class="{{ request()->routeIs('admin.letter_variable_setting') ? 'active' : '' }}">
                                    <a href="{{ route('admin.letter_variable_setting') }}" class="iq-waves-effect">
                                        <i class="ri-settings-4-line"></i>
                                        <span>Letter Variable Setting</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.hrmodule.generate_letter.show') == '1')
                                <li class="{{ request()->routeIs('admin.generateletter') ? 'active' : '' }}">
                                    <a href="{{ route('admin.generateletter') }}" class="iq-waves-effect">
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'logistic')
                            ...
                            @if (session('user_permissions.logisticmodule.logisticsettings.show') == '1' ||
                                    session('user_permissions.logisticmodule.lrcolumnmapping.show') == '1')
                                <li
                                    class="{{ request()->routeIs('admin.logisticothersettings', 'admin.lrcolumnmapping') ? 'active' : '' }}">
                                    ...
                                    <ul id="logisticsettinginfo" class="iq-submenu collapse"
                                        ...
                                        @if (session('user_permissions.logisticmodule.lrcolumnmapping.show') == '1')
                                            <li
                                                class="{{ request()->routeIs('admin.lrcolumnmapping', 'lrcolumnmapping') ? 'active' : '' }}">
                                                <a href="{{ route('admin.lrcolumnmapping') }}">
                                                    <i class="ri-links-line"></i>
                                                    LR Invoice Mapping
                                                </a>
                                            </li>
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'developer')
                            @if (session('user_id') == 1)
                                <li>
                                    <a href="{{ route('admin.downloadmaintemplate') }}" class="iq-waves-effect">
                                        <i class="ri-file-download-line"></i>
                                        <span>Download Main Template</span>
                                    </a>
                                </li>
                            @endif
                        ...
                        @elseif (Session::has('menu') && Session::get('menu') == 'account')
                            @if (session('user_permissions.accountmodule.income.show') == '1')
                                <li class="{{ request()->routeIs('admin.income') ? 'active' : '' }}">
                                    <a href="{{ route('admin.income') }}" class="iq-waves-effect">
                                        <i class="ri-wallet-3-line"></i>
                                        <span>Income</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.accountmodule.expense.show') == '1')
                                <li class="{{ request()->routeIs('admin.expense') ? 'active' : '' }}">
                                    <a href="{{ route('admin.expense') }}" class="iq-waves-effect">
                            ...
                            @if (session('user_permissions.accountmodule.ledger.show') == '1')
                                <li class="{{ request()->routeIs('admin.ledger') ? 'active' : '' }}">
                                    <a href="{{ route('admin.ledger') }}" class="iq-waves-effect">
                                        <i class="ri-book-3-line"></i>
                                        <span>Ledger</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.accountmodule.category.show') == '1')
                                <li class="{{ request()->routeIs('admin.category') ? 'active' : '' }}">
                                    <a href="{{ route('admin.category') }}" class="iq-waves-effect">
                                       <i class="ri-list-check"></i>
                                        <span>Category</span>
                                    </a>
                                </li>
                            @endif
                            @if (session('user_permissions.accountmodule.accountformsetting.show') == '1')
                                <li class="{{ request()->routeIs('admin.accountothersettings') ? 'active' : '' }}">
                                    <a href="{{ route('admin.accountothersettings') }}" class="iq-waves-effect">
                                        <i class="ri-settings-5-line"></i>
                                        <span>Account Other settings </span>
                                    </a>
                                </li>
                            @endif
                        @endif
