                                    ...
                                    <tbody id="admincheckboxes">
                                        ...
                                        @if (session('user_permissions.adminmodule.package.edit') == '1' || $user_id == 1)
                                            <tr id="package">
                                                <td>Package</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='package'
                                                        id="showpackagemenu" name="showpackagemenu" value="1">
                                                </td>
                                                <td>
                                        ...
                                        @if (session('user_permissions.adminmodule.subscription.edit') == '1' || $user_id == 1)
                                            <tr id="subscription">
                                                <td>Subscription</td>
                                                <td>
                                                    <input type="checkbox" class="clickmenu" data-value='subscription'
                                                        id="showsubscriptionmenu" name="showsubscriptionmenu"
                                                        value="1">
                                                </td>
                                                <td>
                                            ...
                                            <tr id="quotationformsetting"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.quotationformsetting.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showquotationformsettingmenu'
                                                            id="viewquotationformsetting" name="viewquotationformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.quotationformsetting.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showquotationformsettingmenu'
                                                            id="editquotationformsetting" name="editquotationformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="thirdpartyquotation">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu'
                                                            id="viewthirdpartyquotation" name="viewthirdpartyquotation"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.quotationmodule.thirdpartyquotation.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyquotationmenu'
                                                            id="editthirdpartyquotation" name="editthirdpartyquotation"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="invoicecommission">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.invoicecommission.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showinvoicecommissionmenu'
                                                            id="deleteinvoicecommission" name="deleteinvoicecommission"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="thirdpartyinvoice">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.invoicemodule.thirdpartyinvoice.delete') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showthirdpartyinvoicemenu'
                                                            id="deletethirdpartyinvoice" name="deletethirdpartyinvoice"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                            ...
                                            <tr id="generate_letter">
                                                ...
                                                <td>
                                                    @if (session('user_permissions.hrmodule.generate_letter.alldata') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showgenerate_lettermenu'
                                                            id="alldatagenerate_letter" name="alldatagenerate_letter"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                    ...
                                    <tbody id="accountcheckboxes">
                                        ...
                                        @if (session('user_permissions.accountmodule.accountformsetting.edit') == '1' || $user_id == 1)
                                            <tr id="accountformsetting" class="account_settings_rows subsettingrows">
                                                ...
                                                <td>
                                                    <input type="checkbox" class="clickmenu"
                                                        data-value='accountformsetting' id="showaccountformsettingmenu"
                                                ...
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.view') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu'
                                                            id="viewaccountformsetting" name="viewaccountformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
                                                ...
                                                <td>
                                                    @if (session('user_permissions.accountmodule.accountformsetting.edit') == '1' || $user_id == 1)
                                                        <input type="checkbox" class="clicksubmenu"
                                                            data-value='showaccountformsettingmenu'
                                                            id="editaccountformsetting" name="editaccountformsetting"
                                                            value="1">
                                                    @else
                                                        -
                                                    @endif
