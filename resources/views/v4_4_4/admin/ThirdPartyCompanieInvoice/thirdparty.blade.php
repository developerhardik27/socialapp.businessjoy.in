...
@if (session('user_permissions.invoicemodule.thirdpartyinvoice.add') == '1')
    @section('addnew')
        {{ route('admin.invoice.addthirdpartycompany') }}
    @endsection
        ...
        $('document').ready(function() {
            ...
            function loaddata() {
                ...
                table = $('#data').DataTable({
                    ...
                    ajax: {
                        type: "GET",
                        url: "{{ route('invoice.company.index') }}",
                        data: function(d) {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                @if (session('user_permissions.invoicemodule.thirdpartyinvoice.edit') == '1')
                                    if (data == 1) {
                                        actionBtns += `
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                @if (session('user_permissions.invoicemodule.thirdpartyinvoice.edit') == '1')
                                    var editCompanyUrl =
                                        "{{ route('admin.invoice.editthirdpartycompany', '__companyId__') }}"
                                        .replace(
                                            '__companyId__', data);
                                    actionBtns += ` 
                                    ...
                                    `;
                                @endif
                                @if (session('user_permissions.invoicemodule.thirdpartyinvoice.delete') == '1')
                                    actionBtns += ` 
            ...
            function chanecompanystatus(companyid, statusvalue) {
                let companyStatusUpdateUrl = "{{ route('invoice.company.statusupdate', '__companyId__') }}"
            ...
            $(document).on("click", ".del-btn", function() {
                ...
                showConfirmationDialog(
                    ...
                    () => {
                        // Success callback
                        loadershow();
                        let companyDeleteUrl = "{{ route('invoice.company.delete', '__deleteId__') }}".replace(
