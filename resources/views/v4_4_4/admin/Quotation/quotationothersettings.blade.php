    ...
    <div id="content-page" class="content-page ">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                ...
                                <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                    <table
                                        id="data"class="table  table-bordered display table-responsive-sm table-responsive-md table-responsive-lg  table-striped text-center">
                                        <thead>
                                            <tr>
                                                <th>Sr</th>
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body" id="appendform">
                                <form id="overduedaysform" style="display: none">
                                    ...
                                    <div class="form-group">
                                        <div class="form-row">
                                            ...
                                            <div class="col-sm-6">
                                                Third Party Quotation : <div
                                                    class="custom-control custom-switch custom-switch-text custom-control-inline">
                                                    <div class="custom-switch-inner">
                                                        <p class="mb-0">
                                                            <input type="checkbox" name="third_party_quotation"
                                                                class="custom-control-input"
                                                                id="thirdpartyquotationswitch" value="1">
                                                            <label class="custom-control-label"
                                                                for="thirdpartyquotationswitch" data-on-label="Active"
                                ...
                                Third Party Quotation : <span id="viewthirdpartyquotation">
                                    <div class="custom-control custom-switch custom-control-inline">
                                        <input type="checkbox" class="custom-control-input" disabled=""
                                            checked="" id="thirdpartyquotationdisabledswitch">
                                        <label class="custom-control-label" id="thirdpartyquotationlabel"
                                            for="thirdpartyquotationdisabledswitch">active</label>
                                    </div>
                                </span> <br>
                            </div>
                        </div>
                ...
                @endif
                @if (session('user_permissions.quotationmodule.quotationformsetting.edit') == 1)
                    <div class="col-md-6">
                        ...
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                ...
                                Customer Drop Down : <span id="startformsetting"> </span>
                            </div>
                        </div>
                    </div>
                @endif
    ...
    <script>
        $('document').ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status == 200 && response.overdueday != '') {
                            ...
                            cgst = data['cgst'];
                            gst = data['gst'];
                            third_party_quotation = data['third_party_quotation'];
                            ...
                            if (third_party_quotation == 1) {
                                $('#thirdpartyquotationswitch').prop('checked',
                                true); // Check the checkbox
                                $('#thirdpartyquotationdisabledswitch').prop('checked',
                                true); // Check the checkbox
                                $('#thirdpartyquotationlabel').text('Active');
                            } else {
                                $('#thirdpartyquotationswitch').prop('checked',
                                false); // Uncheck the checkbox
                                $('#thirdpartyquotationdisabledswitch').prop('checked',
                                false); // Uncheck the checkbox
                                $('#thirdpartyquotationlabel').text('Inactive');
                            }
            ...
            $('#customerformsettingform').on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('quotationcustomerdropdown.store') }}",
                    data: formdata,
                    success: function(response) {
                        // Handle the response from the server
                        if (response.status == 200) {
