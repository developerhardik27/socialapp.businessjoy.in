...
class PdfController extends Controller
{
   ...
   public function __construct()
   {
      ...
      if (isset($_SESSION['folder_name'])) {
         ...
         $this->paymentdetailsModel = 'App\\Models\\v4_2_3\\payment_details';
         $this->quotationModel = 'App\\Models\\v4_2_3\\quotation';
         $this->consignor_copyModel = 'App\\Models\\v4_2_3\\consignor_copyM';
      }
   }
