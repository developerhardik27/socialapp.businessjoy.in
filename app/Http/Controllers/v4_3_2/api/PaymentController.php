...
class PaymentController extends commonController
{
    ...
    public $userId, $companyId, $masterdbname, $invoiceModel, $payment_detailsModel, $rp, $incomeModel, $ledgerModel;
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($payment_inserted) {
                ...
                $description = "invoice:$invoice->inv_no, Payment Paid <br> $request->description";
