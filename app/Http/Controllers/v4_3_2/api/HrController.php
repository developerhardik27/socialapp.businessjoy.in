...
{
    public $userId, $companyId, $masterdbname, $rp, $employeeModel, $companiesholidayModel, $letterModel ,$letter_variable_settingModel;
    ...
    public function holidaystore(Request $request)
    {
        ...
        if ($holiday) {
            return $this->successresponse(200, 'message', 'Comapny succesfully added');
        } else {
            return $this->successresponse(500, 'message', 'Comapny not succesfully added !');
        }
    }
    ...
    public function holidayupdate(Request $request, $id)
    {
        ...
        if ($holiday) {
            return $this->successresponse(200, 'message', 'Holiday updated successfully.');
        }

        return $this->successresponse(500, 'message', 'Holiday updated successfully.');
    }
    ...
    public function letterstore(Request $request)
    {
        ...
        $uploadPath = public_path("uploads/{$this->companyId}/hr/letter");
        ...
        if ($request->hasFile('header_image')) {
            ...
            $headerPath = "uploads/{$this->companyId}/hr/letter/{$headerFileName}";
        ...
        if ($request->hasFile('footer_image')) {
            ...
            $footerPath = "uploads/{$this->companyId}/hr/letter/{$footerFileName}";
