...
{
    public $userId, $companyId, $masterdbname, $transporter_billingModel, $payment_detailsModel, $rp, $ledgerModel, $expenseModel;
        ...
        return $this->executeTransaction(function () use ($request) {
            ...
            if ($validator->fails()) {
                ...
                if ($payment_inserted) {
                    ...
                    $description = "transporter bill:$bill->bill_no, Payment Paid <br> $request->description";

                    $expense = [
                        'expense_id' => $bill->id,
                        'expense_details_id' =>  $payment_inserted->id,
                    ...
                    throw new \Exception("Failed to create payment details");
                }
            }
        });
    }
    ...
    public function destroy($id)
    {
        return $this->executeTransaction(function () use ($id) {
            ...
            $Expense = $this->expenseModel::where('expense_details_id', $id)
                ->where('subtype', 'transporter bill')->first();
