...
class PdfController extends Controller
{
   ...
   public function __construct()
   {
      ...
      if (isset($_SESSION['folder_name'])) {
         ...
         $this->consignor_copyModel = 'App\\Models\\v4_3_2\\consignor_copyM';
      }
   }
   ...
   private function prepareDataForQuotationPDF($quotation, $paymentdetails = null)
   {
      ...
      if ($quotation->third_party_quotation == 1) {
         $jsoncompanydetailsdata = app('App\Http\Controllers\\' . $this->version . '\api\thirdpartycompanyController')->companydetailspdf($quotation->company_id);
      } else {
