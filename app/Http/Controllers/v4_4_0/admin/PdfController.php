...
class PdfController extends Controller
{
   ...
   public function __construct()
   {
      ...
      if (isset($_SESSION['folder_name'])) {
         ...
         $this->paymentdetailsModel = 'App\\Models\\v4_4_0\\payment_details';
         $this->quotationModel = 'App\\Models\\v4_4_0\\quotation';
         $this->consignor_copyModel = 'App\\Models\\v4_4_0\\consignor_copyM';
      }
   }
   ...
   public function letterdownload(string $id)
   {
      ...
      $name = $data['dataformate']['letter_name'] . $fullName . '.pdf';
