...
class customerController extends commonController
{
    ...
    public $userId, $companyId, $masterdbname, $rp, $customerModel, $invoice_other_settingModel, $quotation_other_settingModel;
    ...
    {
        if ($this->rp['invoicemodule']['customer']['view'] != 1 && $this->rp['quotationmodule']['quotationcustomer']['view'] != 1) {
            return $this->successresponse(500, 'message', 'You are Unauthorized');
        }
