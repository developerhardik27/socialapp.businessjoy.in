...
class HrController extends commonController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->filled('removed_files')) {
            ...
            foreach ($request->removed_files as $filePath) {
                ...
                // ✅ HANDLE CV DELETE
                if ($employee->cv_resume == $filePath) {
                    $employee->cv_resume = null;
                }
        ...
        if ($request->hasFile('cv_resume')) {
            ...
            // delete old CV
            if (!empty($employee->cv_resume)) {
                $oldPath = public_path($employee->cv_resume);
            ...
            if (!file_exists(public_path("$basePath/cv_resume"))) {
                mkdir(public_path("$basePath/cv_resume"), 0777, true);
            }
