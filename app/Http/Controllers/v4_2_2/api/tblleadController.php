    ...
    public function importFromExcel(Request $request)
    {
        ...
        try {
            ...
            for ($i = 2; $i <= count($rows); $i++) {
                ...
                // Enum value checks (only if value is present)
                ...
                // If enum validation failed, skip insertion
            ...
            return $this->successresponse(200, 'message', "$importedCount lead(s) imported successfully.");
        } catch (\Exception $e) {
            return $this->successresponse(500, 'message', 'An error occurred: ' . $e->getMessage());
        }
    }
