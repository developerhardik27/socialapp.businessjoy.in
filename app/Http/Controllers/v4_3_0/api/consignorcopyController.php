...
class consignorcopyController extends commonController
{
    ...
    public function show(string $id)
    {
        ...
        // get consignor 
        $consignor = $this->consignorModel::leftjoin($this->masterdbname . '.city', 'consignors.city_id', $this->masterdbname . '.city.id')
        ...
        // get consignee 
        $consignee = $this->consigneeModel::leftjoin($this->masterdbname . '.city', 'consignees.city_id', $this->masterdbname . '.city.id')
