...
{
    public $userId, $companyId, $masterdbname, $transporter_billingModel, $payment_detailsModel, $rp, $ledgerModel, $expenseModel, $incomeModel;
        ...
        return $this->executeTransaction(function () use ($request) {
            ...
            if ($validator->fails()) {
                ...
                if ($payment_inserted) {
                    ...
                    $description = "Transporter Bill:$bill->bill_no";

                    if (!empty($invoice_no)) {
                        $description .= ", Invoice No:$invoice_no";
                    }

                    $description .= ", Payment Paid<br>" . $request->remarks;
