            ...
            if ($company) {
                ...
                if ($company->app_version) {
                    ...
                    $migrationMap = [
                        ...
                        'v4_4_4' => $request->company == 1
                            ? ['database/migrations/v4_4_4/master']
                            ...
                            case 'v4_4_4':
                                ...
                                if ($rp) {
                                    ...
                                    foreach ($rp as $userrp) {
                                        ...
                                        // Add v4_4_4 new module permissions
                                        if(!isset($jsonrp['societymodule'])) {
                                            $jsonrp['societymodule'] = [
                                                
                                                "memberdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "member" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "familymembers" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "karobaridashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "karobarimember" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "karobarimeeting" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "meetingattendance" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "donationdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "donationtype" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "donation" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "postdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "post" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "postcomment" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "postshare" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "eventdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "event" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "eventcomment" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "eventshare" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "policydashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "policy" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "applicationdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "application" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "notificationdashboard" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],
                                                "notification" => ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0],   
                                            ];
                                        }
                                        if(!isset($jsonrp['societymodule']['familyrelation'])) {
                                            $jsonrp['societymodule']['familyrelation'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
                                        if(!isset($jsonrp['societymodule']['businesscategory'])) {
                                            $jsonrp['societymodule']['businesscategory'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
                                        if(!isset($jsonrp['societymodule']['businessubcategory'])) {
                                            $jsonrp['societymodule']['businessubcategory'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
                                        if(!isset($jsonrp['societymodule']['postlike'])) {
                                            $jsonrp['societymodule']['postlike'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
                                        if(!isset($jsonrp['societymodule']['joblike'])) {
                                            $jsonrp['societymodule']['joblike'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
                                        if(!isset($jsonrp['societymodule']['eventlike'])) {
                                            $jsonrp['societymodule']['eventlike'] = ["show" => 0, "add" => 0, "view" => 0, "edit" => 0, "delete" => 0, "alldata" => 0];
                                        }
