...
class quotationController extends commonController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return $this->executeTransaction(function () use ($data, $itemdata, $validator) {
                ...
                if ($company_details) {
                    ...
                    if ($third_party_company) {
                        $quotationrec['third_party_quotation'] = 1;
                        $quotationrec['company_id'] = $third_party_company;
                        $quotationrec['company_details_id'] = null;
                    } else {
                        $quotationrec['company_details_id'] = $company_details_id;
                    }
    ...
    public function edit(string $id)
    {
        ...
        // Check if third party quotation and user has permission
        if ($quotationdetails->third_party_quotation == 1) {
            if ($this->rp['quotationmodule']['thirdpartyquotation']['edit'] != 1 && $this->rp['quotationmodule']['thirdpartyquotation']['add'] != 1) {
                return $this->successresponse(403, 'message', 'You do not have third party company permission. Please set all permissions so that you can edit this quotation.');
            }
        }
        ...
        return $this->executeTransaction(function () use ($request, $id) {
            ...
            if ($validator->fails()) {
                ...
                if ($third_party_company) {
                    ...
                    $quotationrec['company_id'] = $company->id;
                    $quotationrec['third_party_quotation'] = 0;
                    $quotationrec['company_details_id'] = $company_details_id;
                }
